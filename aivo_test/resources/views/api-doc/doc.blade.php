    ...
    <script id="template-article-sample-request" type="text/x-handlebars-template">
        ...
        <form class="form-horizontal">
            <fieldset>
                ...
                <h4><input type="radio" data-sample-request-header-group-id="sample-request-header-@{{@index}}" name="@{{../id}}-sample-request-header" value="@{{@index}}" class="sample-request-header sample-request-switch" @{{#if_eq @index compare=0}} checked@{{/if_eq}}
                    />@{{@key}}</h4>
                ...
                <h4><input type="radio" data-sample-request-param-group-id="sample-request-param-@{{@index}}" name="@{{../id}}-sample-request-param" value="@{{@index}}" class="sample-request-param sample-request-switch" @{{#if_eq @index compare=0}} checked@{{/if_eq}}
                    />@{{@key}}</h4>
